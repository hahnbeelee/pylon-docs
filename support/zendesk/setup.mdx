...
1. Send the Pylon team your Zendesk subdomain in your shared channel. You can
   find your subdomain in your Zendesk URL `https://{subdomain}.zendesk.com`.
2. Visit your [Integrations Page](https://app.usepylon.com/integrations) and hit
   `Connect` under Zendesk
3. Authorize the Zendesk App
4. Click `Manage` on the Zendesk app and confirm the user mapping is set
   properly
