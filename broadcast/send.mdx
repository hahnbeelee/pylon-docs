...
You can choose to send a Broadcast to only channels that have a certain tag. Tags can either be set in Pylon on the [Accounts Page](https://app.usepylon.com/accounts) or come from your CRM. [Connect your CRM](#).
